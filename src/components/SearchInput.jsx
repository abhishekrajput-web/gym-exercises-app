  ...
  return (
    <section className='pt-32 '>
      <div className='px-7 sm:px-14 space-y-12'>
          <h2 className='text-2xl sm:text-3xl md:text-5xl text-black capitalize text-center md:text-center border-b-4 border-red-500 sm:border-none'>awesome exercise you <br /> should know</h2>
