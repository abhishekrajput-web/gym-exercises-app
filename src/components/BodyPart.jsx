...
import ExercisePng from "../assets/images/exercise.png";
  ...
  return (
    <section>
      ...
      <div className="overflow-hidden">
        <h2 className='text-2xl sm:text-3xl md:text-5xl text-black capitalize text-center md:text-center border-b-4 border-red-500 sm:border-none mb-20'>Exercise Categories</h2>
        <Swiper
          slidesPerView="auto"
          spaceBetween={20}
          freeMode
        ...
        >
          ...
          {bodyParts.map((exercise, id) => (
            ...
            <h2 className='text-xl border-b-2 border-b-green-500 hover:opacity-80 '>{exercise}</h2>
          </div>
          </SwiperSlide>
          ))}
